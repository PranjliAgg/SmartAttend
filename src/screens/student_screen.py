...
def student_dashboard():
    ...
    with col2:
        if st.button("Logout", key="loginbackbtn", type="primary", shortcut="control+backspace"):
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_button():
            if st.button("Unenroll from this course", key=f"unenroll{sid}", type="secondary", width="stretch", icon=":material/delete_forever:"):
